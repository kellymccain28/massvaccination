...
plot_prevalence <- function(HPCfolder, outcome, strategy, seas){
  ...
  ggsave(paste0(HPCpath, '03_output/', HPCfolder, "/", df_plot$PEV[1], "_", outcome, "_", strategy, "_", seas, '.png'), width = 16, height = 9, units = 'in')
}

plot_prevalence('HPC_RTSS', 'prevalence_2_10', 'mass', 'seasonal')
plot_prevalence('HPC_RTSS', 'prevalence_2_10', 'mass', 'perennial')
plot_prevalence('HPC_RTSS', 'prevalence_0_100', 'mass', 'seasonal')
plot_prevalence('HPC_RTSS', 'prevalence_0_100', 'mass', 'perennial')

plot_prevalence('HPC_R21', 'prevalence_2_10', 'mass', 'seasonal')
plot_prevalence('HPC_R21', 'prevalence_2_10', 'mass', 'perennial')
plot_prevalence('HPC_R21', 'prevalence_0_100', 'mass', 'seasonal')
plot_prevalence('HPC_R21', 'prevalence_0_100', 'mass', 'perennial')
...
compare_prevalence <- function(outcome, strategy, seas, MDAyn){
  ...
  plt <- ggplot(df_plot) + 
    ...
    labs(y = out_label,
         x = 'Year', 
         title = str2expression(paste('RTSS', 'vs', 'R21', out_label, "mass", 'vaccination', sep = '~')),
